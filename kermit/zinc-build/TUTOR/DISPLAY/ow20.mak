...
#    wmake -f ow20.mak dos32       (makes the DOS display tutorial)
#    wmake -f ow20.mak windows     (makes the Windows display tutorial)
#    wmake -f ow20.mak winnt       (makes the Windows NT display tutorial)
#    wmake -f ow20.mak os2         (makes the OS/2 display tutorial)
