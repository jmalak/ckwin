...
#    wmake -f ow20.mak dos32       (makes the DOS hello tutorial)
#    wmake -f ow20.mak windows     (makes the Windows hello tutorial)
#    wmake -f ow20.mak winnt       (makes the Windows NT hello tutorial)
#    wmake -f ow20.mak win32       (makes the Windows NT hello tutorial)
#    wmake -f ow20.mak os2         (makes the OS/2 hello tutorial)
